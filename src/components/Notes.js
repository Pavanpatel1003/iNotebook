...
const Notes = () => {
    ...
    const updateNote = (currentNote) => {
        ref.current.click();
        setNote({ id: "currentNote_id", etitle: currentNote.title, edescription: currentNote.description, etag: currentNote.tag });
    }
                        ...
                        <div className="modal-body">
                            <form className='my-3'>
                                <div className="form-group my-3">
                                    ...
                                    <input type="text" className="form-control" id="etitle" name="etitle" aria-describedby="emailHelp" placeholder="title" value={note.etitle} onChange={onChange} minLength={5} required />
                                </div>
                                <div className="form-group my-3">
